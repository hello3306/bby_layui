...
layui.use('table', function () {
    ...
    table.render({
        elem: '#test'
        , url: baseUrl+'/hospital/getExpert'
        , toolbar: '#toolbarDemo'
        , title: '用户数据表'
        , headers: {token: token}
        ,where:{
        ...
        , cols: [[
            ...
            , {field: 'outpatient_time', title: '门诊时间', width: 220}
            , {field: 'introduce', title: '介绍', width: 220}
            , {field: 'sort', title: '排序', width: 100, sort: true}
            , {field: 'create_time', title: '添加时间', width: 220}
        ...
        switch (obj.event) {
            case 'getCheckData':
                layer.open({
                    type: 2,
                    area: ['1200px', '600px'],
                    content: 'add_expert.html'+'?code='+hospitalID,
                });
    ...
    table.on('tool(test)', function (obj) {
        ...
        if (obj.event === 'del') {
            ...
            layer.open({
                ...
                maxmin: true,
                area: ['1200px', '600px'],
                content: 'add_expert.html'+'?code='+hospitalID+'&id='+data.id,
            });
        }
    });
});